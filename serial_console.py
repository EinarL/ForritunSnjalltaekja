...
"""
run by using: py serial_console.py -D COM4
Note: You will likely need to specify a different serial port than COM4

you will first need to build and flash the .c file as described in the project-one.c file
located at ../src/main/project-one.c
"""
